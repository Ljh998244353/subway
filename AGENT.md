...
- 当前阶段：P0 项目基线与上下文恢复已完成，下一步进入 P1-I1 信息架构与页面范围。
- 当前代码状态：尚无 `frontend/`、`backend/`、`ai-services/`、`infra/` 或自动化测试工程。
- 当前已有交付：项目规划文档、P0 需求与系统设计文档、`context/` 恢复包、Codex 项目 skill、第三方声明、Typst 汇报稿和已生成的 `slides/slide.pdf`。
...
- 下一步：执行 `P1-I1`，创建信息架构与页面范围文档，不直接开始写前端或后端。
...
3. 不跳阶段、不做大爆炸开发。当前下一步是 `P1-I1`，不要提前创建前端、后端、AI 视频服务或部署工程。
...
AI 必须据此读取 `PROGRESS.md` 和 `context/TODO_NEXT.md`，自动识别当前应执行 `P1-I1`，并完成文档、检查、风险记录和上下文更新。
