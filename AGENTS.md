...
- Current increment: `P5-I1 API mode overview data loader contract`
- Primary role: Frontend Integration Mode
- Auxiliary reviews: Backend, QA, Security/License
- Current base: P4-I1 through P4-I16 are complete, including CP4 closure review and MySQL readiness planning.
- Next focus: add the first narrow frontend API-mode overview data loader contract while keeping mock mode as the default demo path.
