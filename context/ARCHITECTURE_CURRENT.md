...
P5-I3 adds a Store Analysis API-mode data loader contract. Mock mode remains the default and the API path should use the existing synthetic backend contract.
