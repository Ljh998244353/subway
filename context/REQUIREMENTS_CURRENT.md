...
P2-I8 已完成 `/customer-profile` 客群画像页面，覆盖匿名聚合画像摘要、时段分布、楼层偏好、业态偏好和隐私口径说明。下一步 P2-I9 做 CP2 前端 Demo 收口和交接，应整理五个核心页面演示路径、测试报告摘要、已知缺口和 P3 接力；不要扩大到后端、AI 服务或部署工程，不接真实 API，不使用真实商场平面图、真实地图、真实 BIM、真实商场或真实品牌素材，不展示个人轨迹、会员身份、人脸或个人画像。
