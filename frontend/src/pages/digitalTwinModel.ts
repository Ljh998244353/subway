...
export const digitalTwinCockpitLayout = {
  ...
  protectedBoundary: 'mock/API data mode preserved; audited Drei and self-authored synthetic GLB are allowed; no external 3D assets, no real mall material, no real brand logos, no real MySQL, or personal data in P7-R2'
} as const;
